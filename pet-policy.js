document.addEventListener('DOMContentLoaded', () => {
    ...
    // Smooth Scroll for View Policy
    const initSmoothScroll = () => {
      const viewPolicy = document.querySelector('.hero-content .btn-primary');
      if (viewPolicy) {
        viewPolicy.addEventListener('click', (e) => {
          e.preventDefault();
          const target = document.querySelector(viewPolicy.getAttribute('href'));
          if (target) {
            window.scrollTo({
